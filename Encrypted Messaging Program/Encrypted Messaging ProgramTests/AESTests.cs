...
namespace AESTest
{
    ...
    public class KeyExpansionTests
    {
        ...
        public void KeyExpansionA1_128()
        {
            ...
            Byte[,] result = new AES(128).ScheduleKey(HexToByteArr(key));
        ...
        public void KeyExpansionA2_192()
        {
            ...
            Byte[,] result = new AES(192).ScheduleKey(HexToByteArr(key));
            ...
            Assert.AreEqual(expected, WordArrToString(result).Remove(expected.Length), "Key Expansion Test 2 for 192 failed");
        }
        [TestMethod]
        public void KeyExpansionA3_256()
        {
            string key = "603deb1015ca71be2b73aef0857d77811f352c073b6108d72d9810a30914dff4";
            Byte[,] result = new AES(256).ScheduleKey(HexToByteArr(key));
            ...
            Assert.AreEqual(expected, WordArrToString(result).Remove(expected.Length), "Key Expansion Test 3 for 256 failed");
        }
