...
using Encrpytion_Prototype;
using System;
using System.Numerics;
using System.Collections.Generic;
using System.Text;

namespace Encrpytion_Prototype.Tests
{
    [TestClass()]
    ...
    public class Diffie_HellmanTests
    {
        ...
        {
            DHTest_A = new DiffieHellman(128);
            DHTest_B = new DiffieHellman(128);
        }
        ...
        {
            KeyData value = DHTest_A.Initilise(14);
